...
def scheme_apply(procedure, args, env):
    ...
    if isinstance(procedure, BuiltinProcedure):
        ...
        "*** YOUR CODE HERE ***"
        lst = []
        def turn_arg_to_lst(arg, lst):
            if not arg == nil:
                lst.append(arg.first)
                return turn_arg_to_lst(arg.rest, lst)
        turn_arg_to_lst(args, lst)
        ...
        # BEGIN PROBLEM 9
        "*** YOUR CODE HERE ***"
        chlid = procedure.env.make_child_frame(procedure.formals, args)
        return eval_all(procedure.body, chlid)
        # END PROBLEM 9
